...
// [] 4. Автокомплит для тикеров
// [] 5. Пофиксить график при ресайзе окна
// [] 6. Вывести работу с урлом и LS в отдельные модули
// [] 7. Нормально реализовать валидацию на повторяющийся тикер

// TODO components
// [] 1. Вынести график в отдельный компонент
